...
import { MOCK_ADMIN_EMAILS, MOCK_ADMIN_PASSWORDS } from "../mockupData/mockAuthCredentials";
...
function AdminLoginPage() {
  ...
  const {
    ...
    onValidationError: (errs) => {
      if (errs.email || errs.password) showLoginError();
    },
    onValidationSuccess: (emailValue, passwordValue) => {
      const isAdminEmail = MOCK_ADMIN_EMAILS.includes((emailValue || "").toLowerCase());
      const isAdminPassword = MOCK_ADMIN_PASSWORDS.includes(passwordValue || "");
